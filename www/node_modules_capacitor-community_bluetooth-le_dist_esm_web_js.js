(self["webpackChunkcanairio_plugin"] = self["webpackChunkcanairio_plugin"] || []).push([["node_modules_capacitor-community_bluetooth-le_dist_esm_web_js"],{
...
/* harmony import */ var _timeout__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./timeout */ 73386);
...
class BluetoothLeWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_0__.WebPlugin {
    ...
    onAdvertisementReceived(event) {
        ...
        if (isNew || ((_a = BluetoothLe.requestBleDeviceOptions) === null || _a === void 0 ? void 0 : _a.allowDuplicates)) {
            ...
            const result = {
                ...
                uuids: (_b = event.uuids) === null || _b === void 0 ? void 0 : _b.map(_conversion__WEBPACK_IMPORTED_MODULE_1__.webUUIDToString),
            };
    ...
    async connect(options) {
        ...
        try {
            await (0,_timeout__WEBPACK_IMPORTED_MODULE_2__.runWithTimeout)(device.gatt.connect(), this.CONNECTION_TIMEOUT, timeoutError);
        }
        catch (error) {
            // cancel pending connect call, does not work yet in chromium because of a bug:
            // https://bugs.chromium.org/p/chromium/issues/detail?id=684073
            await ((_a = device.gatt) === null || _a === void 0 ? void 0 : _a.disconnect());
